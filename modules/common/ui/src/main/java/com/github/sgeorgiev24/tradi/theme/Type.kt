...
import com.github.sgeorgiev24.tradi.ui.R
...
@Immutable
object CustomTradiTypography : TradiTypography {
...
fun getTypography(typography: TradiTypography) =
    Typography(
